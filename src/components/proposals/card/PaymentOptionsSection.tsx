  ...
  return (
    <div className="p-0">
      <div className="flex justify-between items-center">
        <h3 className="text-[10px] font-semibold text-af-blue-800 dark:text-af-blue-200 mb-1 flex items-center">
          <CreditCard className="mr-1 h-2.5 w-2.5 flex-shrink-0 text-af-blue-600 dark:text-af-blue-400" />
          Opções de Pagamento
        </h3>
        
        {hasDiscount() && (
          <div className="text-[9px] font-medium text-af-green-700 dark:text-af-green-400 whitespace-nowrap">
      ...
      <div className="grid grid-cols-5 gap-1">
        {/* À Vista card - smaller (1/5 of the grid) */}
        <div className="col-span-1 border border-af-blue-100 dark:border-gray-700 rounded p-1 hover:bg-af-blue-50 dark:hover:bg-gray-800 transition-colors shadow-sm bg-white dark:bg-gray-800">
          <p className="font-medium text-af-blue-700 dark:text-af-blue-300 text-[10px]">À Vista</p>
          <p className="text-[11px] font-bold dark:text-white">R$ {discountedValue || '0,00'}</p>
        </div>
        
        {/* Parcelado card - larger (4/5 of the grid) */}
        <div className="col-span-4 border border-af-blue-100 dark:border-gray-700 rounded p-1 hover:bg-af-blue-50 dark:hover:bg-gray-800 transition-colors shadow-sm bg-white dark:bg-gray-800">
          <p className="font-medium text-af-blue-700 dark:text-af-blue-300 text-[10px] mb-0.5">Parcelado</p>
          
          <div className="grid grid-cols-2 gap-1">
            {/* Entry payment section - on the left */}
            <div className="border-r border-af-blue-50 dark:border-gray-700 pr-1">
              <p className="text-[9px] text-af-blue-700 dark:text-af-blue-300 font-medium">
      ...
      <div className="mt-1 pt-1 border-t border-af-blue-100 dark:border-gray-700 text-[8px] text-af-blue-700 dark:text-af-blue-300">
        <p>Pagamento da 1ª parcela: <strong className="dark:text-white">{formattedLastBusinessDay}</strong> até 20h.</p>
